...
const HomePage = () => {
    ...
    async function fun()
    {
        const response = await axios.get('https://dotnetservereapp.azurewebsites.net/api/Loan');
    ...
    async function handleConfirmDelete(){
       try{
        if (loanToDelete) {
            const response = await axios.delete('https://dotnetservereapp.azurewebsites.net/api/Loan/'+loanToDelete);
