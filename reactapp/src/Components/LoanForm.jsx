...
// console.log("id------------",id)
  ...
  {
    const response = await axios.get(`https://dotnetservereapp.azurewebsites.net/api/Loan/${id}`);
  ...
  async function handleAddLoan() {
   ...
   try{
    ...
    if(id)
    {
      const response = await axios.put('https://dotnetservereapp.azurewebsites.net/api/Loan/'+id,requestObject);
