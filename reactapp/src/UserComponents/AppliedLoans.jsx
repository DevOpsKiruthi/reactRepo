...
{
try{
    const response = await axios.get("https://dotnetservereapp.azurewebsites.net/api/LoanApplication/GetLoanApplicationsByUserId?userId="+localStorage.getItem("userId"));
...
async function handleConfirmDelete(){
    if (loanToDelete) {
    const response = await axios.delete('https://dotnetservereapp.azurewebsites.net/api/LoanApplication/'+loanToDelete);
